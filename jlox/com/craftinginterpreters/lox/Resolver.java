...
//> Inheritance begin-super-scope
      ...
      if (stmt.superclass != null) {
          ...
          scopes.peek().put("super", new Variable(
                  new Token(TokenType.SUPER, "super", null, stmt.name.line),
                  VariableState.READ
          ));
      }
      ...
      scopes.peek().put("this", new Variable(
              new Token(TokenType.THIS, "this", null, stmt.name.line),
              VariableState.READ
      ));
  ...
  private void endScope() {
      ...
      for(Map.Entry<String, Variable> entry : scope.entrySet()){
          if(entry.getValue().state == VariableState.DEFINED){
              Lox.error(entry.getValue().name, "Local var is not used.");
          }
      }
  }
//< end-scope
